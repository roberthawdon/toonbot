...
* Adding default timeout for fetching comics (10 seconds)
* Adding per comic timeout column for future implementation

*/

INSERT INTO tbl_system (name, value) VALUES ("fetch_timeout", "10");

ALTER TABLE `tbl_comics`
ADD COLUMN `fetch_timeout` int(4) DEFAULT NULL AFTER `latest`;
