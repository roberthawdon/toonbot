...
* Changing data types of daystart and dayend on tbl_user_prefs

*/

ALTER TABLE tbl_user_prefs MODIFY daystart varchar(50);
ALTER TABLE tbl_user_prefs MODIFY dayend varchar(50);
