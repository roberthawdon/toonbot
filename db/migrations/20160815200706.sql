...
* Added mode to comics table to allow for hiding and disabling.
* Setting all current comics to enabled.

*/

ALTER TABLE `tbl_comics`
ADD COLUMN `mode` TINYINT(1) NOT NULL DEFAULT 0 AFTER `lastfetched`;

UPDATE `tbl_comics` SET `mode` = 0;
